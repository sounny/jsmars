...
/*
 * This is based off of the StampLayer.FloatingPointImageOp
 * 
...
public class FloatingPointImageOp implements BufferedImageOp {
	...
	public FloatingPointImageOp() {
	}
		
	public FloatingPointImageOp(double minStretchValue, double maxStretchValue) {
		imageMin=minStretchValue;
		imageMax=maxStretchValue;
	}
