...
public class SortASCCmd implements QuickMenuCommand {

	CommandReceiver cr;	
	private JTable jTable;
	private int eventX = -1;
	
	public SortASCCmd(CommandReceiver knowsHowTodo, JTable atable, int eventColumn) {		
	...
	public void execute() {
		...
		if (sorter != null) {
			...
			sorter.setSort(column, SortDirection.ASCENDING); //primary sort
		}
