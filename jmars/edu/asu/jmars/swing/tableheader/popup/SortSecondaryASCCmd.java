...
public class SortSecondaryASCCmd implements QuickMenuCommand {

	CommandReceiver cr;	
	private JTable jTable;
	private int eventX = -1;
	
	public SortSecondaryASCCmd(CommandReceiver knowsHowTodo, JTable atable, int eventColumn) {		
	...
	public void execute() {
		...
		if (sorter != null) {
			...
			sorter.addSort(column, SortDirection.SECONDARY_ASCENDING); //secondary sort
		}
