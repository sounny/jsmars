...
public class NoSortingCmd implements QuickMenuCommand {

	CommandReceiver cr;	
	private JTable jTable;
	private int eventX = -1;
	
	public NoSortingCmd(CommandReceiver knowsHowTodo, JTable atable, int eventColumn) {		
	...
	public void execute() {
		...
		if (sorter != null) {
			...
			sorter.setSort(column, SortDirection.NO_SORT); //NO sort
		}
	}
}
