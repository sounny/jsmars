...
public class SortSecondaryDESCCmd implements QuickMenuCommand {

	CommandReceiver cr;
	private JTable jTable;
	private int eventX = -1;

	public SortSecondaryDESCCmd(CommandReceiver knowsHowTodo, JTable atable, int eventColumn) {
	...
	public void execute() {
		...
		if (sorter != null) {
			...
			sorter.addSort(column, SortDirection.SECONDARY_DESCENDING); // secondary sort
		}
	}
