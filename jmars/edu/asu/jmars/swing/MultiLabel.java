...
/**
 * This code was obtained from a post to one of Sun's online discussion forums
 * for Java:
 * <p>
 * http://forum.java.sun.com/thread.jsp?forum=57&thread=219991&start=0&range=15#2135304
 * <p>
 * Legal status: According to Sun's Terms of Use for this forum's website,
 * source code posted in such a manner inherently comes with a royalty-free
 * license to all forum users, hence it is effectively in the public domain.
 */
public class MultiLabel extends JComponent implements SwingConstants
{
    ...
    public MultiLabel(String str, int horizontalAlignment, int textAlignment,
        ...
        for (int i = 0; i < num_lines; i++)
        {
            ...
            else if (ha == CENTER)
            {
                ...
                if (ha == LEFT)
                    ...
                    x = insets.left
                        + (clientAreaWidth - line_widths[i]) / 2;
            }
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        MultiLabel x1 = new MultiLabel(wiseText, MultiLabel.RIGHT,
                                       MultiLabel.RIGHT);
        MultiLabel x2 = new MultiLabel(wiseText, MultiLabel.CENTER);
        MultiLabel x3 = new MultiLabel(wiseText, MultiLabel.CENTER,
                                       MultiLabel.RIGHT);
        MultiLabel x4 = new MultiLabel(wiseText, MultiLabel.CENTER,
                                       MultiLabel.CENTER);
        MultiLabel x5 = new MultiLabel(wiseText, MultiLabel.RIGHT,
        ...
        for (int i = 0; i < mainPanel.getComponentCount(); i++)
            ((JComponent) mainPanel.getComponent(i))
