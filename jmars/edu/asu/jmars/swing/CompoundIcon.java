...
public class CompoundIcon implements Icon
{
    ...
    private boolean useWidthOfComponent = false;
    private int widthOfComponentOffset = 0;

    private int lastIconStart = -1;
    private int lastIconEnd = -1;
...
//
    ...
    */
	...
	public int getLastIconStart() {
	    return this.lastIconStart;
	}
	public int getLastIconEnd() {
	    return this.lastIconEnd;
	}

    public void setUseWidthOfComponent(boolean flag) {
        useWidthOfComponent = flag;
    }
    public void setWidthOfComponentOffset(int offset) {
        widthOfComponentOffset = offset;
    }
}
