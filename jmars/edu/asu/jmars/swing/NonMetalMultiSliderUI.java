 ...
 ** #createUI}.
 **/
public class NonMetalMultiSliderUI extends BasicSliderUI {
	
    private static DebugLog log = DebugLog.instance();
	protected static Icon horizThumbIcon = new ImageIcon(Util.loadImage("resources/slider4.gif"));
	protected static Icon vertThumbIcon = new ImageIcon(Util.loadImage("resources/slider4.gif"));

	protected MultiSlider mslider;
	protected Rectangle extraThumbRect = null;

	public NonMetalMultiSliderUI(JSlider c) {
		super(c);
	}
	
    public static ComponentUI createUI(JSlider c) {
        return new NonMetalMultiSliderUI(c);
	 }
